...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: KHIBBNa3tiTv/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: hyFJ3_aDpfpg/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__uQu7N)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__dOb6M)}
              />
            </React.Fragment>
          ),
          value: args.children
