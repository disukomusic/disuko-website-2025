...
import MenuSection from "../../MenuSection"; // plasmic-import: rT-Io0tdANaB/component
...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: TsvWy0xNjSQO/css
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__cYv8)}
                    label={"Item 3"}
                    value={"item3"}
                  />
