...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: hbh6X4CAAZ5a/css

import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: jk1OG94_OnYk/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__qvwzT)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__wMnYb)}
              role={"img"}
            />
          ),
