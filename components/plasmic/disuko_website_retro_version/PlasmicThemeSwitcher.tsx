...
import Label from "../../Label"; // plasmic-import: _lNalJbTgwuu/component
...
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: cTNgYtMBz7wZ/icon
    ...
    >
      ...
      <MenuPopover
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <MenuItem label={"none"} value={"base"} />
